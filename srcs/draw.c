...
{
	if (keycode == 'w' || keycode == W_ALLOW)
		change_locale(vars, 0, -1);
	else if (keycode == 'd' || keycode == D_ALLOW)
		change_locale(vars, 1, 0);
	else if (keycode == 'a' || keycode == A_ALLOW)
		change_locale(vars, -1, 0);
	else if (keycode == 's' || keycode == S_ALLOW)
		change_locale(vars, 0, 1);
	else if (keycode == 'x' || keycode == ESC)
	{
